...
## Current Target
Continue TypeScript practice till around **12 July**, then move to:
- PostgreSQL
- Next.js

The goal is to finish the TypeScript basics strongly enough so that TypeScript feels natural while learning modern full-stack tools.
...
## Next Steps
Planned next topics after Day 6:
- more class practice
- revision of weak topics
- selected advanced TypeScript basics needed for Next.js
- then shift to PostgreSQL and Next.js practice